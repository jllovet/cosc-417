...
{\Large COSC 417 \hspace{2cm} Assignment 2}
\bigskip

\emph{Instructions:}

(a) Due date and time: as indicated on Blackboard.


b) %Work in teams of 3-4  students  and 
Submit on Blackboard. The assignment will not be graded (see the policy in the syllabus).

 (c) For editing your homework. I recommend that you use Latex via Overleaf, see the template posted on Blackboard. 
 
           
	  
The template has an  example showing how to do the state diagram  of a finite automaton. If you have trouble, you can draw the state diagram and insert a digital photo in the .tex file (see the template how to do this).
  ...
  Do (or at least sketch the solutions) without turning in anything the following exercises from the textbook: 1.4 (a-d), 1.5 (a-d), 1.6(a-d), 1.7(a-d).  (Some of them have solutions in the book; still try to do them before checking the solution. Some of this exercises may show up in quizzes).
\medskip
