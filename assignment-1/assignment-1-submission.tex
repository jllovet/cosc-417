...
To ground this in an intuition, consider the preceding diagram, in which we perform a similar operation to Sipser, weaving back and forth between the two sets in a structured way to ensure all of the elements are included in the enumeration.

TODO: Add explicit function.
