...
To ground this in an intuition, consider the following diagram, in which we perform a similar operation, weaving back and forth between the two sets in a structured way to ensure all of the elements are included in the enumeration.
